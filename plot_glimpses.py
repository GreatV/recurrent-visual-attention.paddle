...
def parse_arguments():
    ...
    arg.add_argument('--plot_dir', type=str, required=True, help=
        'path to directory containing pickle dumps')
    arg.add_argument('--epoch', type=int, required=True, help=
        'epoch of desired plot')
...
def main(plot_dir, epoch):
    ...
    def updateData(i):
        ...
        for j, ax in enumerate(axs.flat):
            ...
            ax.add_patch(rect)
    anim = animation.FuncAnimation(fig, updateData, frames=num_anims,
